...
import 'schema/lecture_record.dart';
import 'schema/chats_record.dart';
import 'schema/chat_messages_record.dart';
import 'schema/notification_record.dart';
import 'schema/letter_record.dart';
import 'schema/issued_book_record.dart';
...
export 'schema/lecture_record.dart';
export 'schema/chats_record.dart';
export 'schema/chat_messages_record.dart';
export 'schema/notification_record.dart';
export 'schema/letter_record.dart';
export 'schema/issued_book_record.dart';
...
/// Functions to query LectureRecords (as a Stream and as a Future).
Stream<List<LectureRecord>> queryLectureRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LectureRecord.collection,
...
Future<List<LectureRecord>> queryLectureRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<LectureRecord>> queryLectureRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query LetterRecords (as a Stream and as a Future).
Stream<List<LetterRecord>> queryLetterRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LetterRecord.collection,
...
Future<List<LetterRecord>> queryLetterRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<LetterRecord>> queryLetterRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query IssuedBookRecords (as a Stream and as a Future).
Stream<List<IssuedBookRecord>> queryIssuedBookRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      IssuedBookRecord.collection,
...
Future<List<IssuedBookRecord>> queryIssuedBookRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<IssuedBookRecord>> queryIssuedBookRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
