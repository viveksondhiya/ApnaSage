    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'photo_url':
          ...
          break;
        case 'enrollment':
          result.enrollment = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'is_teacher':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _enrollment;
  String? get enrollment => _$this._enrollment;
  set enrollment(String? enrollment) => _$this._enrollment = enrollment;
